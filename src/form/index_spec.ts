...
import { ChangeDetection, Schema as ComponentOptions, Style } from '@schematics/angular/component/schema';

// tslint:disable:max-line-length
describe('Form Schematic', () => {
  ...
  it('should fail if specified module does not exist', () => {
    const options = {
      ...defaultOptions,
      module: '/projects/bar/src/app.moduleXXX.ts',
    };
